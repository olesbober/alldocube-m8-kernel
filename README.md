# Alldocube M8 Kernel Modification

This is the repository that contains my work at attempting to modify the kernel of the Alldocube M8 Android device to allow OTG charging. Here I will list:
